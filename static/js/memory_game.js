...
function AddPoint(){
    console.log('Le bouton a été tiré')
    score=score + 18;
    updateScore();
}
...
function updateStopwatch() {
    ...
    var hours = Math.floor(elapsedTime / 1000 / 60 / 60); // calcul en heures
    var displayTime = pad(hours) + ":" + pad(minutes) + ":" + pad(seconds); // format d'affichage du temps
